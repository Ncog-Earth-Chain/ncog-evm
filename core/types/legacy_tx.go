...
// func (tx *LegacyTx) chainID() *big.Int { return deriveChainId(tx.Signature) } // Adjust for ML-DSA-87
func (tx *LegacyTx) chainID() *big.Int {
	// For ML-DSA-87, there's no V component; return nil or a default chain ID.
	return new(big.Int) // Return zero if chain ID is not applicable
}
