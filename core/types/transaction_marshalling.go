...
func (t *Transaction) UnmarshalJSON(input []byte) error {
	...
	case LegacyTxType:
		...
		if dec.Nonce == nil || dec.GasPrice == nil || dec.Gas == nil || dec.Value == nil || dec.Data == nil || dec.Signature == nil {
			return errors.New("missing required fields in transaction")
		}
		itx.Nonce = uint64(*dec.Nonce)
		itx.GasPrice = (*big.Int)(dec.GasPrice)
		itx.Gas = uint64(*dec.Gas)
	...
	case AccessListTxType:
		var itx AccessListTx
		inner = &itx
		if dec.ChainID == nil || dec.Nonce == nil || dec.GasPrice == nil || dec.Gas == nil || dec.Value == nil || dec.Data == nil || dec.Signature == nil {
			return errors.New("missing required fields in transaction")
		}
		itx.ChainID = (*big.Int)(dec.ChainID)
		itx.Nonce = uint64(*dec.Nonce)
