...
// Pubkey returns the MLDSA-87 public key of the node, if present.
func (n *Node) Pubkey() *cryptod.PublicKey {
	var key cryptod.PublicKey
	if n.Load((*MLDsa87Key)(&key)) != nil {
		return nil
	}
	return &key
}
...
// The Go syntax representation of an ID is a call to HexID.
